...
public sealed class WeaponContainer : Component
{
	...
	public bool Has( GameObject prefab )
	{
		...
		return All.Any( w => w.GameObject.Components.GetInDescendantsOrSelf<WeaponComponent>( ).DisplayName == prefab.Components.GetInDescendantsOrSelf<WeaponComponent>( ).DisplayName );
	}
	...
	public void Give( GameObject prefab, bool shouldDeploy = false )
	{
		...
		var weapon = weaponGo.Components.GetInDescendantsOrSelf<WeaponComponent>( );
		...
		var nextWeponGo = weaponGo.Components.GetInDescendantsOrSelf<BaseGun>(  );
